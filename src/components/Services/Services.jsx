    ...
    const services = [
        {
            ...
            duration: "55 минут",
            price: "180 PLN",
            message: "Добрый день! Хочу записаться на индивидуальную сессию"
        },
        {
            ...
            duration: "90 минут",
            price: "250 PLN",
            message: "Добрый день! Хочу записаться на семейную сессию"
                ...
                <div className="services-grid">
                    {services.map((service, index) => (
                        <div key={index} className="service-card">
                            ...
                            <a href={`https://t.me/antonina_sapego_psiholog?text=${service.message}`}
